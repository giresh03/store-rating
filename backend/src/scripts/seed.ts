...
async function main() {
  ...
  // Create Store Owners
  const storeOwner1Password = await hashPassword('Owner123!');
  ...
  const storeOwner2Password = await hashPassword('Owner456!');
  ...
  const normalUsers = [
    ...
    },
    {
      ...
      password: await hashPassword('User456!'),
    ...
    },
    {
      ...
      password: await hashPassword('User789!'),
    ...
    },
    {
      ...
      password: await hashPassword('User012!'),
